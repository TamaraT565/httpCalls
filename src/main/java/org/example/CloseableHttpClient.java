...
public class CloseableHttpClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Facts> posts = mapper.readValue(response.getEntity().getContent(), new TypeReference<>() {
        });
        posts.stream().filter(cat -> cat.getUpvotes() != null).forEach(System.out::println);
    }
}
